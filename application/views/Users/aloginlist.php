<?php include('header.php'); ?>
  ...
  <div class="form-inline my-2 my-lg-0">
    <?php echo form_open('adminsection/searchalogin'); ?>
    <div class="row">
    ...
    <table>
      ...
      <tbody id="myTable">
        ...
        <tr>
          ...
          <td>
            <?=  anchor("adminsection/editalogin/{$sl->id}",'Edit',['class'=>'btn btn-primary']);  ?>
          </td>
          <td>
            <?=  anchor("adminsection/delalogin/{$sl->id}",'Delete',['class'=>'btn btn-danger']);  ?>
            <td>
        </tr>
      <?php endforeach;?>
    <?php else:?>
