...
<div class="container">
  ...
  <div class="text-center">
    <h4 class="lead" style="margin-top:30px;">Edit marks of Students:</h4>
  </div>
  ...
  <?php echo form_open("adminsection/updatecomp3stud/{$studdata->id}"); ?>
  <div class="col-6">
  <label class="lead" for="inputDefault" >Enter the Hallticket no. of Student:</label>
  <?php echo form_input(['class'=>'form-control','placeholder'=>'HallTicket No.','name'=>'hall_ticket','value'=>set_value("hallticket",$studdata->hall_ticket)]); ?>
...
<?php } ?>
  ...
  <div class="col-6" style="margin-top:20px;">
      ...
      <?php echo form_submit(['type'=>'submit','class'=>'btn btn-primary btn-block','value'=>'Update Marks']); ?>
  </div>
