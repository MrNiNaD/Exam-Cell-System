...
<div class="container">
  ...
  <?php echo form_open_multipart('studentsection/ktexdetails'); ?>
  ...
  <div class="row">
    ...
    <div class="col-3" style="margin-top:10px">
      ...
      <?php echo form_input(['class'=>'form-control','name'=>'es1','value'=>set_value("es1")]); ?>
    </div>
    ...
    <div class="col-2" style="margin-top:10px">
      ...
      <?php echo form_input(['class'=>'form-control','name'=>'is1','value'=>set_value("is1")]); ?>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-3" style="margin-top:10px">
      ...
      <?php echo form_input(['class'=>'form-control','name'=>'es2','value'=>set_value("es2")]); ?>
    </div>
    ...
    <div class="col-2" style="margin-top:10px">
      ...
      <?php echo form_input(['class'=>'form-control','name'=>'is2','value'=>set_value("is2")]); ?>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-3" style="margin-top:10px">
      ...
      <?php echo form_input(['class'=>'form-control','name'=>'es3','value'=>set_value("es3")]); ?>
    </div>
    ...
    <div class="col-2" style="margin-top:10px">
      ...
      <?php echo form_input(['class'=>'form-control','name'=>'is3','value'=>set_value("is3")]); ?>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-3" style="margin-top:10px">
      ...
      <?php echo form_input(['class'=>'form-control','name'=>'es4','value'=>set_value("es4")]); ?>
    </div>
    ...
    <div class="col-2" style="margin-top:10px">
      ...
      <?php echo form_input(['class'=>'form-control','name'=>'is4','value'=>set_value("is4")]); ?>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-3" style="margin-top:10px">
      ...
      <?php echo form_input(['class'=>'form-control','name'=>'es5','value'=>set_value("es5")]); ?>
    </div>
    ...
    <div class="col-2" style="margin-top:10px">
      ...
      <?php echo form_input(['class'=>'form-control','name'=>'is5','value'=>set_value("is5")]); ?>
    </div>
